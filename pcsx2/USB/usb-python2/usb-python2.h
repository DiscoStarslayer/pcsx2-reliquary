...
namespace usb_python2
{
	enum : u32
	{
		...
		BID_TOYSMARCH_P1_START,
		BID_TOYSMARCH_P1_LEFT,
		BID_TOYSMARCH_P1_RIGHT,
		BID_TOYSMARCH_P1_CYMBAL,
		BID_TOYSMARCH_P1_DRUM_L,
		BID_TOYSMARCH_P1_DRUM_R,

		BID_TOYSMARCH_P2_START,
		BID_TOYSMARCH_P2_LEFT,
		BID_TOYSMARCH_P2_RIGHT,
		BID_TOYSMARCH_P2_CYMBAL,
		BID_TOYSMARCH_P2_DRUM_L,
		BID_TOYSMARCH_P2_DRUM_R,

		BID_THRILLDRIVE_START,
		BID_THRILLDRIVE_GEARSHIFT_DOWN,
		BID_THRILLDRIVE_GEARSHIFT_UP,
		BID_THRILLDRIVE_STEERING_LEFT,
		BID_THRILLDRIVE_STEERING_RIGHT,
		BID_THRILLDRIVE_ACCELERATOR,
		BID_THRILLDRIVE_BRAKE,
		BID_THRILLDRIVE_SEATBELT,
	};
